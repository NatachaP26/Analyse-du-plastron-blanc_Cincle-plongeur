...
plot(tab_males_plus2A2018$Area ~ tab_males_plus2A2018$Mass)
abline(lm(tab_males_plus2A2018$Area ~ tab_males_plus2A2018$Mass))
 # represente moins bien la droite de regression lineaire donc bof
